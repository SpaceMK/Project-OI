...
public class MoveBehaviour : GenericBehaviour
{
	...
	public KeyCode jumpButton;              // Default jump button.
	...
	{
		// Get jump input.
		if (!jump && Input.GetKeyDown(jumpButton) && behaviourManager.IsCurrentBehaviour(this.behaviourCode) && !behaviourManager.IsOverriding())
		{
			jump = true;
		}
	}
